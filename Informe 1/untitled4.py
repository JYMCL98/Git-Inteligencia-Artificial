# -*- coding: utf-8 -*-
"""
Created on Tue Apr 26 11:34:01 2022
...
def class_img(categorias,tam_img1,tam_img2):
    ...
    for direccion in categorias:
        ...
        for imagen in os.listdir(direc+'/'+ direccion):
            ...
            img2 = Image.open(direc+'/' + direccion + '/' + imagen).resize((tam_img,tam_img))
    ...
    imagenes = imagenes.reshape(-1)
    # Extraemos los valores de cada píxel (0-255)
    #imagenes = imagenes[:,:,:,:] 
    archivo = open("D:/Documents/Data"+"/Plants_train_1.csv","w")
