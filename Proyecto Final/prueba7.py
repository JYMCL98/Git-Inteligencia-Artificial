...
def convertir_imagenes(categorias,tamanio_img1,tamanio_img2):
    ...
    for direccion in categorias:
        ...
        for imagen in os.listdir('D:/Desktop/Data/Data2/'+ direccion):
            img2 = Image.open('D:/Desktop/Data/Data2/' + direccion + '/' + imagen).resize((tamanio_img,tamanio_img)) # Redimensionamos la imagen a 28x28
            ...
            if y == 743: # Número de elementos de la carpeta
                break
            y += 1
        y = 0
        # Lee solo 1 carpeta
